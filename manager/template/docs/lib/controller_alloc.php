...
if ($athlete ==-1 || $coach ==-1 ) {
 ...
 $n = $d->select("allocation_master", "u_id=$athlete");
  $data = mysqli_num_rows($n);
  if ($data>0) {
        echo "This athlete has alredy alloted crew!!!!!";
        exit();
    }
    ...
    if (isset($_POST) && !empty($_POST)) {
        if (isset($_POST['Insert'])) {
            ...
            $a = array(
                ...
                'ac_date' => $m->get_data(test_input('ac_date')),
