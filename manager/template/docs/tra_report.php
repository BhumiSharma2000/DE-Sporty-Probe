...
?>
      ...
      <div class="app-title">
        <div>
          <h1><i class="fa fa-file-text-o"></i> Expense Report</h1>
        ...
        <div class="col-md-12">
          <div class="tile">
            <section class="invoice">
              <div class="row mb-4">
                <div class="col-6">
                  <h2 class="page-header"><i class="fa fa-file-text" aria-hidden="true"></i> &nbsp;Travel Expense Report</h2>
                </div>
                <div class="col-6">
             ...
             $q5 = $d->select("expense_master","u_id='$id' AND ex_type_id=3");
             $i=0;
          ...
          while($result6 = mysqli_fetch_array($q6))
{
        ...
        ?> 
                  ...
                  <hr style="height:1px;border:none;color:#333;background-color:#333; width: 100px; margin-left: 980px;" />
                <!--   <hr style="width: 100px; margin-left: 850px;" size="30"> -->

                <?php
                $qr = "SELECT SUM(expense) AS totalsum FROM expense_master where u_id ='$id'  ANd ex_type_id=3";
...
$als = "totalsum";
                $ttl  = $d->sum_data('expense','expense_master' ,"u_id=35",'$als');
                   ...
                   */      
                ?>
                   <p style="margin-left: 980px;" ><b> Total</b> <?= $sum; ?></p>
                </div>
              </div>
              <br>
