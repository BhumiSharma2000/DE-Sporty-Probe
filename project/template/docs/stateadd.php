...
<html lang="en">
   ...
   <body class="app sidebar-mini rtl">
      ...
      <main class="app-content" style="background-color: #FFFFFF; ">
        ...
        <form method="POST" action="lib/controller_state.php" enctype="multipart/form-data"  name="form1" >
         <h2>Entry Of State</h2>
         
          <div class="form-group">
            <label class="control-label">State</label>
            <input class="form-control" type="text" name="statename" required placeholder=" Enter State">
             <?php
