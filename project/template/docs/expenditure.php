...
<html lang="en">
   ...
   <body class="app sidebar-mini rtl">
      ...
      <main class="app-content" style="background-color: #FFFFFF; ">
       ...
       <form method="POST" action="lib/controller_ex.php" enctype="multipart/form-data">
         <h2>Entry Of Expenditure</h2>
         
          <div class="form-group">
            <label class="control-label">Expenditure Name</label>
            <input class="form-control" type="text"  placeholder=" Enter role" name="ex">
               <?php
