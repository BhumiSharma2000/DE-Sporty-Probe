...
<html lang="en">
   ...
   <body class="app sidebar-mini rtl">
      ...
      <main class="app-content" style="background-color: #FFFFFF; ">
       ...
       <form method="POST" action="lib/controller_sport.php" enctype="multipart/form-data" onsubmit=" return validation()" name="f1">
         <h2>Entry Of Sport</h2>
         
          <div class="form-group">
            <label class="control-label">Sport</label>
            <input class="form-control" type="text"   placeholder=" Enter Sport" name="sport" id='ff'>
           <?php
