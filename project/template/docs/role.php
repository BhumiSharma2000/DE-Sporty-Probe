...
<html lang="en">
   ...
   <body class="app sidebar-mini rtl">
      ...
      <main class="app-content" style="background-color: #FFFFFF; ">
       ...
       <form method="POST" action="lib/controller_role.php" enctype="multipart/form-data">
         <h2>Entry Of Role</h2>
         
          <div class="form-group">
            <label class="control-label">Role Name</label>
            <input class="form-control" type="text"  placeholder=" Enter role" name="role">
               <?php
   ...
   ?>
      ...
      <?php if(isset($_SESSION['city'])){?>
        <script>
          swal("Role Entered Successfully ","");
